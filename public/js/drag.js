...
$(function () {
    ...
    function initAudio(){
        ...
        audio.addEventListener('timeupdate', function(e) {
            ...
            var curSlot = parseInt(currTime/(audio.duration/TIMELINE_SLOTS));
            currenTimeNode.textContent = parseInt(currTime / 60) + ':' + parseInt(currTime % 60) + ' slot ' + curSlot;
            clockVideo(curSlot);
        }, false);
    ...
    function drawDropzone() {
        for(var i=0;i< 10;i++){
            ...
            slot.appendTo('#dropzone');
            var theDrop = document.querySelector('#drop_'+i);
            theDrop.addEventListener('drop', function (e) {
                if (e.preventDefault)e.preventDefault();
                if (e.stopPropagation)e.stopPropagation();

                console.log('dropped on dropzone slot ');
                this.className = "dropHolder";
            ...
            theDrop.addEventListener('dragenter', function (e) {
                this.className = "dropHolder over";
            });
            theDrop.addEventListener('dragleave', function (e) {
                this.className = "dropHolder";
            });
            theDrop.addEventListener('dragover', function (e) {
                if (e.preventDefault) {
                    e.preventDefault();
                }
    ...
    var dropZoneOne = document.querySelector('#upload');
